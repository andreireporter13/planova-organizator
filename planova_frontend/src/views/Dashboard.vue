<template>
    <div class="dashboard">
            ...
            <div class="popup">
                <div class="popup-header">
                    <h4>
                        ✨ Adaugă
                        {{
                            popup.type === "task" ? "Task Nou" : "Eveniment Nou"
                        }}
                    </h4>
                ...
                <div class="popup-actions">
                    <button @click="addItem" class="btn btn-primary">
                        ✅ Adaugă
                        {{ popup.type === "task" ? "Task" : "Eveniment" }}
                    </button>
            ...
            <div class="popup">
                ...
                <div class="move-options">
                    <button
                        ...
                        @click="
                            moveCard(movePopup.fromCol, movePopup.index, idx)
                        "
                        class="btn move-btn"
                        :class="
                            idx === movePopup.fromCol
                                ? 'btn-disabled'
                                : 'btn-primary'
                        "
                    >
        ...
        <!-- Popup Archive -->
        <div
            v-if="archivePopup.visible"
            class="popup-overlay"
            @click.self="closeArchivePopup"
        >
            <div class="popup popup-large">
                <div class="popup-header">
                    <h4>🗄️ Arhiva</h4>
                    <button @click="closeArchivePopup" class="close-btn">
                        ✕
                    </button>
                </div>

                <div class="archive-stats">
                    📊 Total elemente arhivate:
                ...
                <div class="archive-list">
                    ...
                    >
                        ...
                        <div class="card-actions">
                            <button
                                @click="restoreFromArchive(i)"
                                class="card-btn btn-restore"
                            >
                                ↩️ Restaurează
                            </button>
                            <button
                                @click="deleteFromArchive(i)"
                                class="card-btn btn-delete"
                            >
                                🗑️ Șterge
                            </button>
        ...
        <!-- Popup Details -->
        <div
            v-if="detailsPopup.visible"
            class="popup-overlay"
            @click.self="closeDetailsPopup"
        >
            <div class="popup">
                <div class="popup-header">
                    <h4>
                        📋 Detalii
                        {{
                            detailsPopup.item?.type === "task"
                                ? "Task"
                                : "Eveniment"
                        }}
                    </h4>
                    <button @click="closeDetailsPopup" class="close-btn">
                        ✕
                    </button>
                </div>
                ...
                <div v-if="detailsPopup.item" class="details-content">
                    ...
                    <div class="detail-group" v-if="detailsPopup.item.date">
                        ...
                        <div class="detail-value">
                            📅 {{ formatDate(detailsPopup.item.date) }}
                        </div>
                    </div>
                ...
                <div class="popup-actions">
                    <button
                        @click="generateContract(detailsPopup.item)"
                        class="btn btn-primary"
                    >
                        📄 Generează Contract
                    </button>
                    <button
                        @click="generatePDF(detailsPopup.item)"
...
<style scoped>
@import "../assets/css/dashboard/dashboard_enhanced.css";
</style>
